@if ( $show )
<div class="fixed top-0 left-0 w-full h-full mx-auto overflow-x-hidden overflow-y-auto outline-none xmodal "
    x-data="{
        show: true
    }"
    wire:show="show"
    ...
    <div class="relative mx-auto pointer-events-none w-96 modal-dialog">
        <div
            ...
            <div class="flex flex-wrap items-center justify-end flex-shrink-0 p-4 border-t border-gray-200 modal-footer rounded-b-md">
                <button type="button" wire:click="hide" class="px-6 py-2 text-xs font-medium leading-tight text-gray-700 uppercase transition duration-150 ease-in-out bg-gray-200 rounded shadow-md hover:bg-gray-200 hover:shadow-lg focus:bg-gray-200 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-200 active:shadow-lg" data-bs-dismiss="modal">Close</button>
